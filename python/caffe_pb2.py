...
_EXTRACTFEATUREPARAMETER_RUNMODE = _descriptor.EnumDescriptor(
  name='RunMode',
  full_name='caffe.ExtractFeatureParameter.RunMode',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_NETPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='print_net_info', full_name='caffe.NetParameter.print_net_info', index=9,
...
_LAYERPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='label_specific_add_param', full_name='caffe.LayerParameter.label_specific_add_param', index=59,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='normalize_param', full_name='caffe.LayerParameter.normalize_param', index=60,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='l2norm_param', full_name='caffe.LayerParameter.l2norm_param', index=61,
...
_EXTRACTFEATUREPARAMETER = _descriptor.Descriptor(
  name='ExtractFeatureParameter',
  full_name='caffe.ExtractFeatureParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='run_mode', full_name='caffe.ExtractFeatureParameter.run_mode', index=0,
      number=17, type=14, cpp_type=8, label=1,
      has_default_value=True, default_value=1,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='device_id', full_name='caffe.ExtractFeatureParameter.device_id', index=1,
      number=18, type=5, cpp_type=1, label=1,
      has_default_value=True, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='image_list', full_name='caffe.ExtractFeatureParameter.image_list', index=2,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=unicode("", "utf-8"),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='image_pair_list', full_name='caffe.ExtractFeatureParameter.image_pair_list', index=3,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=unicode("", "utf-8"),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='model_config', full_name='caffe.ExtractFeatureParameter.model_config', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='batch_size', full_name='caffe.ExtractFeatureParameter.batch_size', index=5,
      number=5, type=5, cpp_type=1, label=1,
      has_default_value=True, default_value=1,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  nested_types=[],
  enum_types=[
    _EXTRACTFEATUREPARAMETER_RUNMODE,
  ],
  options=None,
  is_extendable=False,
  extension_ranges=[],
...
_MODELINITPARAMETER = _descriptor.Descriptor(
  name='ModelInitParameter',
  full_name='caffe.ModelInitParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='image_root_path', full_name='caffe.ModelInitParameter.image_root_path', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=unicode("", "utf-8"),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='deploy_path', full_name='caffe.ModelInitParameter.deploy_path', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=unicode("", "utf-8"),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='model_path', full_name='caffe.ModelInitParameter.model_path', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=unicode("", "utf-8"),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='output_path', full_name='caffe.ModelInitParameter.output_path', index=3,
      number=4, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=unicode("", "utf-8"),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='data_transform', full_name='caffe.ModelInitParameter.data_transform', index=4,
      number=5, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_EXTRACTFEATUREPARAMETER.fields_by_name['run_mode'].enum_type = _EXTRACTFEATUREPARAMETER_RUNMODE
_EXTRACTFEATUREPARAMETER.fields_by_name['model_config'].message_type = _MODELINITPARAMETER
_EXTRACTFEATUREPARAMETER_RUNMODE.containing_type = _EXTRACTFEATUREPARAMETER;
_MODELINITPARAMETER.fields_by_name['data_transform'].message_type = _TRANSFORMATIONPARAMETER
...
DESCRIPTOR.message_types_by_name['ExtractFeatureParameter'] = _EXTRACTFEATUREPARAMETER
DESCRIPTOR.message_types_by_name['ModelInitParameter'] = _MODELINITPARAMETER
...
class LabelSpecificAddParameter(_message.Message):
  __metaclass__ = _reflection.GeneratedProtocolMessageType
...
class ExtractFeatureParameter(_message.Message):
  __metaclass__ = _reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _EXTRACTFEATUREPARAMETER

  # @@protoc_insertion_point(class_scope:caffe.ExtractFeatureParameter)

class ModelInitParameter(_message.Message):
  __metaclass__ = _reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _MODELINITPARAMETER

  # @@protoc_insertion_point(class_scope:caffe.ModelInitParameter)

class L2NormParameter(_message.Message):
  __metaclass__ = _reflection.GeneratedProtocolMessageType
