...
def train_model(device_id, resume_training = None, model_date = None, iterate_num = None):
    ...
    source_ = train_set.train_lmdb_data[dataset][0] 
    num_out = train_set.train_lmdb_data[dataset][1] 
    ...
    data_layer['data'], data_layer['label'] = LmdbDataLayer(source_, batch_size_)
