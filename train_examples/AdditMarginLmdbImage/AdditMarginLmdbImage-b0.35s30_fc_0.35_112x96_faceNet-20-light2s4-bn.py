...
def train_model(device_id, resume_training = None, model_date = None, iterate_num = None):
    ...
    #patch params
    source_ = "/home/zkx/Data_sdb/TrainData/Data_sdc/Patches/MultiPatches/image_list/train_list/shot_Oriental_Age_Lan_DHUA_PAKJ_Indon_Migrant_celeb_label.txt"
    batch_size_ = 64
    root_folder_ = "/home/zkx/Data_sdb/TrainData/Data_sdc/Patches/MultiPatches/fc_0.35_112x96/"
