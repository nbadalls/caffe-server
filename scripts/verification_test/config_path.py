...
ConfigPath.local_data_path = "/media/minivision/OliverSSD/FaceRecognition"
ConfigPath.local_caffe_path = "/home/minivision/SoftWare/caffe-server"
ConfigPath.model_root_path = "/media/minivision/OliverSSD/FaceRecognition/verification_select_best_models"
...
ConfigPath.test_data_set = {
         ...
         'XCH-Anroid':{
           'pairs_file' : "{}/TestSet/XCH_PAD_01_23/image_pair_list.txt".format(ConfigPath.local_data_path),
           'imgs_folder' : "{}/TestSet/XCH_PAD_01_23/patches/XCH-Ad/".format(ConfigPath.local_data_path),
           'image_list'  : "{}/TestSet/XCH_PAD_01_23/image_list.txt".format(ConfigPath.local_data_path)
           },
